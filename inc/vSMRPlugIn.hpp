...
class vSMRPlugIn : public EuroScopePlugIn::CPlugIn
{
    ...
    OnRadarScreenCreated(const char * displayName,
    ...
    virtual void OnGetTagItem(EuroScopePlugIn::CFlightPlan flightPlan,
                              ...
                              double * fontSize);
    virtual void
    OnFlightPlanDisconnect(EuroScopePlugIn::CFlightPlan flightPlan);
    virtual void OnTimer(int counter);

    private:
    std::vector<std::unique_ptr<EuroScopePlugIn::CRadarScreen>> radarScreens;
};
